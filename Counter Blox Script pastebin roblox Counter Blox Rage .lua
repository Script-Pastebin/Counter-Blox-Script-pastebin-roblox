...
nosmoketext.Text = "Remove smokes"
...
tracertext.Text = "Bullet tracers"
...
crouchtekst.Text = "No crouch cooldown"
...
bhoptext_2.Text = "Infinite money"
...
--[[ Script Description:
							...
							This script have functions:Esp,aim,rage,misc(Bhop,Inf money,,Backtrack)
